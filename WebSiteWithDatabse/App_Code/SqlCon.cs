...
public class SqlConn
{
    ...
    public void Connectdb()
    {
        ...
        {
            string PASS = "123456";
            CString_ = "Data Source=" + SERVER + ";Database=" + DATABASE + ";User ID=" + USER + ";Password=" + PASS + ";Connection Timeout=" + DB_TIMEOUT + ";Min Pool Size=" + DB_MINPOOL + ";Max Pool Size=" + DB_MAXPOOL + ";Pooling =True;Persist Security Info=True;Connection Lifetime=7200;";
